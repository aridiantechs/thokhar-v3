...
return [
    ...
    '2fa'=>[
        ...
        'minute'=>'دقيقة ',
        'code' => 'رمز التحقق ',
        'heading' => 'نحن دائما على استعداد لتزويدك بأعلى مستوى من الدعم.',
    ],
    ...
    'user' => [
        ...
        'heading_text' => 'نحن دائما على استعداد لتزويدك بأعلى مستوى من الدعم ، العلاقة بيننا وبين كل عميل مهمة للغاية بالنسبة لنا.',
        'name' => 'اسم',
        'membership' => 'عضوية',
        'data_reg' => 'تاريخ مسجل',
    ...
    'frontend_legal' => [
        ...
        'legal_head_text'=>'إن خصوصية وأمن معلومات مستخدمي وزوار موقع ذخر يعتبر موضوع في غاية الأهمية والاوليات بالنسبة للموقع',
        'legal_paragraph'=>'يرجى العلم بأن موقع ذخر أوالقائمين عليه، قد بذلوا العناية اللازمة في تقديم هذه الخدمة بدون أي مقابل، لذا فإنه يخلي مسؤولياته عن اي اثار قانونية تنشأ عن ذلك.موقع ذخر او القائمين عليه لا يقدم أي إقرارات أو ضمانات بشأن البيانات والمعلومات المقدمة وبالرغم من موثوقية مصادر المعلومات والعناية المعقولة في البيانات الا أنه لا يقر بأن المعلومات التي يتضمنها هذا الموقع او وثائقه هي معلومات كاملة أو خالية من أي خطأ أو غير مضللة أو أنها تصلح إلى غرض محدد. فالوثيقة او المعلومات في هذا الموقع إنما تقدم معلومات عامة فقط . كما أن المعلومات وأي رأي وارد في هذا الموقع أو اي وثيقة منه لا تشكل عرضا أو دعوة لتقديم عرض لشراء أو بيع أي أوراق مالية أو غيرها من المنتجات الإستثمارية ذات الصلة بتلك الأوراق المالية أو الإستثمارات. وليس الغرض من هذه الموقع أو وثائقه تقديم مشورة شخصية في مجال الإستثمار كما أنها لا تأخذ في الإعتبار الأهداف الإستثمارية أو الوضع المالي أو الإحتياجات المحددة لأي شخص معين قد يستلم هذه الوثيقة. ينبغي للمستثمرين السعي للحصول على المشورة المالية أو القانونية أو الضريبية من شركة مالية مرخصة من هيئة السوق المالية او الجهات الحكومية ذات العلاقة بشأن مدى ملائمة الإستثمار في أي أوراق مالية ، أو استثمار آخر أو أية استراتيجيات إستثمار جرت مناقشتها أو التوصية بها في هذا الموقع او الوثائق الصادرة عنه، وينبغي للمستخدمين تفهم أن البيانات المتعلقة بالتوقعات المستقبلية الوارد من هذا الموقع قد لا تتحقق. كذلك ينبغي للمستخدمين ملاحظة أن الدخل من أوراق مالية من هذا النوع أو غيرها من الإستثمارات ، إن وجد ، قد يتعرض للتقلبات وبأن سعر أو قيمة تلك الأوراق المالية والإستثمارات يكون عرضةُ للإرتفاع أو الإنخفاض.
        كما أن التقلبات في أسعار الصرف للعملات قد يكون لها 
       آثار سلبية على القيمة أو الثمن، أو الدخل المتأتي من استثمارات معينة. وبناء عليه
        ، يمكن للمستخدمين أن يحصلوا على عائد يكون أقل من مبلغ رأسمالهم المستثمر أساسا.
        والموقع او المسؤولون فيه ، بما في ذلك الموظفين التابعية للموقع ، لا يكونون مسؤولين 
       عن أي أضرار مباشرة أو غير مباشرة أو أي خسارة أو أضرار أخرى قد تنشأ ، بصورة مباشرة أو غير مباشرة ، 
       من أي استخدام للمعلومات الواردة في هذه الوثيقة من الوثائق الصادرة من الموقع. تخضع المعلومات الصادرة 
       من الموقع وأية توصيات واردة فيها للتغيير دون إشعار مسبق. وموقع ذخر لا يتحمل أي مسؤولية عن تحديث المعلومات الواردة في هذه الوثائق الصادرة منه.
        ولا يجوز تغيير أو استنساخ أو إرسال أو توزيع هذه الوثيقة من وثائق الموقع كليا أو جزئيا بأي شكل أو بأي وسيلة. 
       كما يراعى أن هذه الوثائق ليست موجهة إلى أو معدة للتوزيع أو الإستخدامها من قبل أي شخص أو كيان سواء كان مواط
       نا أو مقيما في أي مكان أو دولة أو بلد أو
        أية جهه قضائية أخرى، حيثما يكون مثل هذا التوزيع أو النشر أو توافر أو استخدام الوثائق الصادرة 
       من الموقع مخالفا للقانون أو يتطلب من الموقع او القائمين عليه القيام بأي تسجيل أو استيفاء أي شرط من شروط الترخيص ضمن
        ذلك البلد أو تلك الجهه القضائية.',

        'legal_sub_heading1'=>'إن خصوصية وأمن معلومات للمستخدمين وزار موقع ذخر يعتبر موضوع في غاية الأهمية والاوليات بالنسبة للموقع ، لذا فإننا نلتزم بالإجراءات التالية',
        'legal_sub_points1'=>'تأمين مقاييس أمنية وإجراءات تمنع الوصول غير المصرح لمعلومات العملاء ويشمل: استخدام مستويات متعددة من أنظمة التحكم والمصادقة الثنائية لتحقيق أمن البيانات، مراجعة دورية للأجهزة وانظمة الحماية والشبكات.',
        'legal_sub_points2'=>'السماح فقط للموظفين المصرح لهم -الذين تستدعي طبيعة ومجال عملهم- استخدام معلومات العملاء والاطلاع عليها.',
        'legal_sub_points3'=>'عدم الإفصاح لأي جهة خارجية بالمعلومات الخاصة بالعميل ما لم يكن قد أبلغنا مسبقاً من خلال بيانات إفصاح أو اتفاقيات، أو حصلنا على تفويض منه بذلك، أو كان ذلك مطلوبا منا بموجب القانون.',
        'legal_sub_points4'=>'اتخاذ الإجراءات النظامية والتأديبية اللازمة عند مخالفة أحد الموظفين لضوابط أمن وخصوصية المعلومات.',
        'legal_sub_points5'=>'في حال ملاحظة ما يثير الريبة أو التعرض لحادثة ذات علاقة بأمن المعلومات نأمل إبلاغنا بأسرع وقت من خلال زيارة صفحة “اتصل بنا',
        
        'legal_form_heading'=>'النشرة البريدية',
        'legal_form_input_placeholder'=>'هل لديك كوبون',
    ...
    'frontend_about' => [
        ...
        'about_section1_description' => 'ذخر هو مستشارك للتخطيط المالي الذي يأخذك خطوة بخطوة لبناء محفظتك الإستثمارية وفق افضل الممارسات في مجال ادارة الثروات',

        'why_thokar'=>'لماذا ذخر؟',
        'why_thokar_desc'=>'مستشارك للتخطيط المالي الذي يتيح لك المعرفة الضرورية لتتمكن من إستثمار أموالك كالمحترفين بتكلفة أقل مقارنة بالاستثمار التقليدي',

        'about_coffee_started_it_all' => '   القهوة بدأت كل شيء   ',
        'about_coffee_text' => 'بعد مراسلة في  فضاء تويتر ، إلتقى وليد باكرمان (محلل مالي) مع د.علي الشهري (أمن التقنيات المالية)في احد مقاهي الرياض الجميلة (د.كيف)، للحديث عن موضوع منهجية الإستثمار الشخصي، وكان من الواضح لهما في نهاية ذلك اللقاء الفريد أنهما لم يكونا شغوفين فقط بموضوع الاستثمار بل يشكلان المزيج المثالي لبناء حل لمشكلة جوهرية  للمستثمرين الأفراد.',

        'mission' => 'الرسالة ',
        'mission_text' => 'مهمتنا ان نكون المخطط المالي الموثوق للافراد',
        ...
        'investment_li_1' => 'الإدخار أولاً .',
        'investment_li_2' => 'منهجيتنا الاستثمارية  :  الاستثمار على الاجل الطويل والاعتماد على ثلاث اركان : الادخار أولاً ، منهجية استثمار حصيفة ، سحر العوائد المتراكمة',
        ...
        'team' => 'فريق العمل',
        'team_member_1'=>'د.علي الشهري',
        'team_member_2'=>'وليد باكرمان',
    ...
    'frontend_disclaimer' => [
        'text' => 'جى العلم بأن موقع ذخر أوالقائمين عليه، قد بذلوا العناية اللازمة في تقديم هذه الخدمة بدون أي مقابل، لذا فإنه يخلي مسؤولياته عن اي اثار قانونية تنشأ عن ذلك.موقع ذخر او القائمين عليه لا يقدم أي إقرارات أو ضمانات بشأن البيانات والمعلومات المقدمة وبالرغم من موثوقية مصادر المعلومات والعناية المعقولة في البيانات الا أنه لا يقر بأن المعلومات التي يتضمنها هذا الموقع او وثائقه هي معلومات كاملة أو خالية من أي خطأ أو غير مضللة أو أنها تصلح إلى غرض محدد. فالوثيقة او المعلومات في هذا الموقع إنما تقدم معلومات عامة فقط . كما أن المعلومات وأي رأي وارد في هذا الموقع أو اي وثيقة منه لا تشكل عرضا أو دعوة لتقديم عرض لشراء أو بيع أي أوراق مالية أو غيرها من المنتجات الإستثمارية ذات الصلة بتلك الأوراق المالية أو الإستثمارات. وليس الغرض من هذه الموقع أو وثائقه تقديم مشورة شخصية في مجال الإستثمار كما أنها لا تأخذ في الإعتبار الأهداف الإستثمارية أو الوضع المالي أو الإحتياجات المحددة لأي شخص معين قد يستلم هذه الوثيقة. ينبغي للمستثمرين السعي للحصول على المشورة المالية أو القانونية أو الضريبية من شركة مالية مرخصة من هيئة السوق المالية او الجهات الحكومية ذات العلاقة بشأن مدى ملائمة الإستثمار في أي أوراق مالية ، أو استثمار آخر أو أية استراتيجيات إستثمار جرت مناقشتها أو التوصية بها في هذا الموقع او الوثائق الصادرة عنه، وينبغي للمستخدمين تفهم أن البيانات المتعلقة بالتوقعات المستقبلية الوارد من هذا الموقع قد لا تتحقق. كذلك ينبغي للمستخدمين ملاحظة أن الدخل من أوراق مالية من هذا النوع أو غيرها من الإستثمارات ، إن وجد ، قد يتعرض للتقلبات وبأن سعر أو قيمة تلك الأوراق المالية والإستثمارات يكون عرضةُ للإرتفاع أو الإنخفاض.
 كما أن التقلبات في أسعار الصرف للعملات قد يكون لها 
آثار سلبية على القيمة أو الثمن، أو الدخل المتأتي من استثمارات معينة. وبناء عليه
 ، يمكن للمستخدمين أن يحصلوا على عائد يكون أقل من مبلغ رأسمالهم المستثمر أساسا.
 والموقع او المسؤولون فيه ، بما في ذلك الموظفين التابعية للموقع ، لا يكونون مسؤولين 
...
لتحقيق الحرية المالية وفق اكثر المعايير المالية موثوقية وحصافة    ', 
    ...
    'awareness' => [
        ...
        'awareness_title' => 'الاستثمار على الاجل الطويل والاعتماد على ثلاث اركان:',
        'awareness_details' => 'الادخار أولا، منهجية استثمار حصيفة ، سحر العوائد المتراكمة',
    ],
    ...
    'income' => [
        'income_heading' => 'هو تقدير لمبلغ المال الذي يولده الفرد أو الأعمال التجارية على مدار السنة',
        'Annual Income' => 'الرجاء ادخال الدخل السنوي ( بما في ذلك الراتب والمكافأة وايجارت العقارات وماشابه )',
    ],

    'gosi' => [
        'gosi_heading' => 'يعد نظام التأمينات الاجتماعية صورة من صور التعاون والتكافل الاجتماعي التي يقدمها المجتمع لمواطينه ويقوم على رعاية العاملين في القطاع الخاص والعام',
    ],

    'investing_plan' => [
        'investing_plan_heading' => 'خطة الاستثمار هي استخدام الأموال المتاحة، ووضع خطة توقعات مستقبلية لتحقيق عائد يتلاءم مع المبلغ المستثمر ونسبة المخاطرة والفترة الزمنية المرغوبة',
    ],

    'net_worth' => [
        'Introduction' => 'مقدمة',
        'thinks his net worth is' => ' هل تعتقد ان صافي ثروتك هو النقد المتاح في حسابك البنكي فقط؟ هو يشمل اكثر من هذا. هيا نكتشف ذلك. ',
    ...
    'wizard_q' => [
        ...
        'Do you have Deposits in Banks' => 'هل لديك سيولة نقدية / وديعة لاجل (مرابحة) في البنك؟ (في حالة نعم ،  ادخل القيمة السوقية بالريال السعودي )',
        'Do you have Stocks' => 'هل لديك محفظة أسهم ؟ (في حالة نعم ،  ادخل القيمة السوقية بالريال السعودي )',
        'Do you have Bonds or Sukuk' => 'هل لديك  صكوك او سندات؟ (في حالة نعم ،  ادخل القيمة السوقية بالريال السعودي )',
        'Do you have Real Estate' => 'هل لديك أصول عقارية ( اراضي ، عمائر ، وحدات صناديق عقارية) ؟ (في حالة نعم ،  ادخل القيمة السوقية بالريال السعودي )',
        'Do you have Private business' => 'هل لديك أعمال ومشاريع خاصة (في حالة نعم ،  ادخل القيمة التقديرية بالريال السعودي )',
        'Do you have other assets' => 'هل لديك أصول اخرى ( ذهب ، بتكوين ، اخرى )؟ (في حالة نعم ،  ادخل القيمة السوقية بالريال السعودي )',

        'Expecting salary at retirement' => 'الراتب المتوقع عند التقاعد(شهري)',
        'Monthly subscription' => 'مبلغ اشتراك التامينات الاجتماعية(شهري)',
    ...
    'retirement_age_message' => 'يجب ألا يكون سن التقاعد أقل من العمر الحالي',
