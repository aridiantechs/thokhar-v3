...
class Questionnaire extends Model
{
    ...
    */
    ...
    public function update_investing_amount(array $data)
    {
        return Questionnaire::where('fk_user_id', auth()->user()->id)
                ->orderBy('questionnaire_id', 'DESC')
                ->first()
                ->update([
                    'investing_amount' => json_encode($data),
                ]);
    }
    ...
    */
    ...
    {
        return (integer)$this->getNetAssets($user)['net_assets']['financial_assets']['cash_and_deposit'] + (integer)$this->getNetAssets($user)['net_assets']['financial_assets']['deposits'];
    }
