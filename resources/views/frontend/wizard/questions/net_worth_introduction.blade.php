		...
		<div class="nav-tabs-wrapper mt-5 mobile d-block d-lg-none">
			<ul class="nav nav-tabs d-flex align-items-center">
				...
				<li class="nav-item nav-item-3">
					<a class="text-left nav-link active" data-toggle="tab" href="#">
				...
				<li class="nav-item nav-item-4">
					<a class="text-left nav-link success" href="{{ route('income', locale()) }}">
			...
			<div class="col-12 col-lg-3 text-center">
				...
				<div class="nav-tabs-wrapper desktop d-none d-lg-block">
					<ul class="nav nav-tabs d-block">
						<li class="nav-item">
							<a class="text-left nav-link success redirect" href="{{ route('income', locale()) }}">
						...
						<!-- Main -->
                            <li class="nav-item" data-id="1">
                              <a class="text-left nav-link success" data-toggle="tab" href="#net-worth-intro">
                                 <span class="step-parent" data-bar="2"></span>
                                 <span class="step-text">
                                     <span>
                                        صافي الثروة
                                ...
                                <li class="nav-item sub-item subitem-1">
                                  <a class="text-left nav-link active" data-toggle="tab" data-parent-id="1" href="#net-worth-intro">
                                     <span class="step-parent" data-bar="3"></span>
                                     <span class="step-text">
                                         <span>
                                             مقدمة
                                ...
                                <li class="nav-item sub-item subitem-1">
                                  <a class="text-left nav-link" data-toggle="tab" data-parent-id="1" href="#cash-money">
                                     <span class="step-parent" data-bar="4"></span>
                                     <span class="step-text">
                                         <span>
                                             المال النقدي
                                ...
                                <li class="nav-item sub-item subitem-1">
                                  <a class="text-left nav-link" data-toggle="tab" data-parent-id="1" href="#menu1">
