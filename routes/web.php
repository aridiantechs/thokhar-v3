...
*/
    ...
    Route::group([
      ...
      */
      ...
      Route::post('/profile-save', 'UserController@storeProfile')->name('profile-save');
      
      // Free version and reports
      Route::get('/awareness',  'QuestionnaireController@awareness')->name('awareness');
