...
return [
    ...
    'frontend_about' => [
        ...
        'mission_li_2' => 'Practical and immediate application.',
        'mission_li_3' => 'Prudent ,far from randomness.',
        'mission_li_4' => 'Meet personal need',
...
تلك الجهه القضائية'
    ...
    'awareness' => [
        'title'=>'awareness',
        'Reach To The Financial Freedom' => 'Magic of compounding returns',
        'awareness_title' => 'Long-term investment Approach that relies on:',
        'awareness_details' => 'Saving first، Prudent investing approach , The magic of compounding returns.',
    ],


    'investing_amount' => [
        'title'=>'Investment',
        'Your age today' => 'Your age today',
        'Monthly investing Payment' => 'Monthly investing Payment',
        'Initial amount ( one time )' => 'Initial amount ( one time )',
        'Retire age( 60 as default and can not changes )' => 'Retire age. ( 60 as default and can not changes )',
    ],


    'plan' => [
        'Gold Plan' => 'Gold Plan',
        'Advisory Session for 30 Mins' => 'Advisory Session for 30 Mins',
        'Buy now' => 'Buy now',
        'Your' => 'Your',
    ],
    ...
    'steps' => [
        'help you with more value to your savings' => 'Help you with more value to your savings',
        'Answer our personal survey' => 'Answer our personal survey' ,
        'Financial Advisor will design investing plan tailored to your needs' => 'Financial Advisor will design investing plan tailored to your needs',
        'Start investing like a Pro right a way' => 'Start investing like a Pro right a way',
        'Start Now' => 'Start Now',
    ...
    'net_worth' => [
        ...
        'thinks his net worth is' => "Do you think your net worth is only cash in your bank account? It includes more than this. Let's find out.",
    ...
    'wizard_q' => [
        ...
        'Do you have Deposits in Banks' => 'Do you have Deposits in Banks ? <br> ( if yes , Enter  Value in SAR ) ',
        'Do you have Stocks' => 'Do you have Stocks ? <br> ( if yes , Enter Market Value in SAR ) ',
        'Do you have Bonds or Sukuk' => 'Do you have Bonds or Sukuk ? <br> ( if yes , Enter Market Value in SAR ) ',
        'Do you have Real Estate' => 'Do you have Real Estate ( lands , properties , REITS ) ? <br> ( if yes , Enter Market Value in SAR ) ',
        'Do you have Private business' => 'Do you have Private business ? <br> ( if yes , Estimated value in SAR ) ',
        'Do you have other assets' => 'Do you have other assets ( bitcoin, gold, etc) ? <br> ( if yes , Market Value in SAR ) ',
