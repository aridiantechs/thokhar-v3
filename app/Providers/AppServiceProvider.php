...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(Request $request)
    {
        ...
        View::share(['align'=>$align,'align3letter'=>$align3letter,'reverseAlign3Letter'=>$reverseAlign3Letter,'alignShort'=>$alignShort,'arrowAlign'=>$arrowAlign,'textAlign'=>$textAlign,'textAlignMd'=>$textAlignMd,'btnAlign'=>$btnAlign]);
    }
}
