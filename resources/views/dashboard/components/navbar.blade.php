<div class="row">
    ...
    <div class="col-lg-1 col-md-3 col-sm-4 col-6 mw-100">
        <a class="nav-link setting_icons" href="{{ route('site_management', app()->getLocale()) }}">
            <img src="{{ asset('backend_assets/admin_dashboard/images/dashboard_icons2.png') }}"><p class="setting_text" >Support</p>
        </a>
    </div>
    <div class="col-lg-1 col-md-3 col-sm-4 col-6 mw-100">
    ...
    <div class="col-lg-1 col-md-3 col-sm-4 col-6 mw-100">
        <a class="nav-link setting_icons" href="{{ route('counseling', app()->getLocale()) }}">
            <img src="{{ asset('backend_assets/admin_dashboard/images/dashboard_icons8.png') }}"><p class="setting_text" >Counseling</p>
        </a>
    </div>
</div>