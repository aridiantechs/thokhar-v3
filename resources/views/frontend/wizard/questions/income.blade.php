		...
		<div class="row row-grid">
			<div class="col-12 col-lg-9 {{-- order-md-1 --}} pr-md-5">
				...
				<div class="tab-content">
					...
					<div id="net-worth-intro" class="container tab-pane"><br>
			...
			<div class="col-12 col-lg-3 text-center">
				...
				<div class="nav-tabs-wrapper desktop d-none d-lg-block">
					...
					<ul class="nav nav-tabs d-block d-ltr">
						<li class="nav-item">
							<a class="text-{{$align}} nav-link active" data-toggle="tab"  href="#home"{{-- href="{{ route('income', locale()) }}" --}}>
								<span class="step-parent step-parent-1" data-bar="1"></span>
								<span class="step-text">
									<span>
									الدخل السنوي
						...
						<!-- Main -->
                            <li class="nav-item" data-id="1">
                              <a class="text-{{$align}} nav-link" data-toggle="tab" href="#net-worth-intro">
                                 <span class="step-parent" data-bar="2"></span>
                                 <span class="step-text">
                                     <span>
                                        صافي الثروة
                                ...
                                <li class="nav-item sub-item subitem-1">
                                  <a class="text-{{$align}} nav-link" data-toggle="tab" data-parent-id="1" href="#net-worth-intro">
                                     <span class="step-parent" data-bar="3"></span>
                                     <span class="step-text">
                                         <span>
                                             مقدمة
